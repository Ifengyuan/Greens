...
public class DataRedisConfig {
    ...
    //新增字符串
    public void save(String key,System value){
    ...
    //新增List
    public void save(String key, List<Object> list){redisTemplate.opsForList().leftPushAll(key,list);}
    //新增Set
